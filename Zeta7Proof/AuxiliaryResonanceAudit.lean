...
/-! Full types and transitive-axiom audit for every declaration in the P5 resonance, P6 joint
rank and P7 compatible-basis increment, including generated helpers. -/
...
run_cmd do
  let modules := #[`Zeta7Proof.AuxiliaryResonanceBand, `Zeta7Proof.AuxiliaryResonanceConstruction,
    `Zeta7Proof.AuxiliaryResonanceNegative, `Zeta7Proof.AuxiliaryResonanceOperator,
    `Zeta7Proof.AuxiliaryResonanceReduction, `Zeta7Proof.AuxiliaryResonanceProportional,
    `Zeta7Proof.AuxiliaryResonanceConcomitant, `Zeta7Proof.AuxiliaryResonanceSource,
    `Zeta7Proof.AuxiliaryResonanceShifts, `Zeta7Proof.AuxiliaryLayerCalculus,
    `Zeta7Proof.AuxiliaryJointFourth, `Zeta7Proof.AuxiliaryGammaNumerators,
    `Zeta7Proof.AuxiliaryJointThird, `Zeta7Proof.AuxiliaryFlagBasis,
    `Zeta7Proof.AuxiliarySharpBound]
  ...
  for idx in [:env.header.moduleNames.size] do
    ...
    for name in data.constNames ++ data.extraConstNames do
      ...
      logInfo ("AUXILIARY_RESONANCE_AXIOM_JSON " ++ (Json.mkObj [
        ("name", toJson name.toString), ("module", toJson moduleName.toString),
        ("axioms", toJson (axs.toList.map Name.toString))]).compress)
  logInfo m!"AUXILIARY RESONANCE AUDIT PASSED: {names.size} declarations."
